...
# TODO:
# 1. Create .env and move SECRET_KEY to the env file
...
SECRET_KEY = 'django-insecure-((%-14=narsk4e+(c9atnet85*3z6s9gr)*%)f9^3m9e(a02$='
...
MIDDLEWARE = [
    ...
    'ch.custom_middleware.CustomMiddleware',
]
